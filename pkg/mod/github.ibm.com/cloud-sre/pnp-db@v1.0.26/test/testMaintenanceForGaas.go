...
func TestMaintenanceForGaas(database *sql.DB, gaasServices []string) int {
	FCT := "TestMaintenanceForGaas: "
	failed := 0

	log.Println("======== "+FCT+" Test 1 InsertMaintenance ========")
	crnFull := []string{"crn:v1:watson::"+gaasServices[0]+":location1::::",
				}
	...
	crnFull2 := []string{"crn:v1:watson:public:"+gaasServices[1]+":location2::::",
						"crn:v1::public:LIBERTY-for-java:location3::::",
				}
	...
	queryStr4 := db.RESOURCE_QUERY_CRN + "=crn:v1:::"+gaasServices[1]+":Location2::::"
	...
	queryStr5 := db.RESOURCE_QUERY_CRN + "=crn:v1:watson:PUBLIC:"+gaasServices[1]+":::::" + "&" + db.MAINTENANCE_QUERY_CREATION_TIME_START + "=" + creationTimeStart5 +"&" +db.MAINTENANCE_QUERY_CREATION_TIME_END+"=" + creationTimeEnd5
	...
	log.Println("Test get Maintenance")
	queryStr6 := db.RESOURCE_QUERY_CNAME + "=&"+db.RESOURCE_QUERY_CNAME + "=&"+db.RESOURCE_QUERY_SERVICE_NAME + "="+gaasServices[0]+"&"+ db.MAINTENANCE_QUERY_CREATION_TIME_START + "=" + creationTimeStart5 +"&" +db.MAINTENANCE_QUERY_CREATION_TIME_END+"=" + creationTimeEnd5
	...
	crnFull8 := []string{"crn:v1:watson:aa:LIBERTY-for-java:location2::::",
				}
	...
	resource9a := datastore.ResourceInsert {
		SourceCreationTime: "2018-07-07T22:01:01Z",
		CRNFull: 			"crn:v1:::"+gaasServices[5]+":::::",
		State:				"ok",
		OperationalStatus: 	"none",
		SourceID:			"resource_idmain9a",
		Source:				"gaas_test_sourcemain9a",
		Status:				"ok",
	...
	resource9b := datastore.ResourceInsert {
		SourceCreationTime: "2018-07-07T22:01:01Z",
		CRNFull: 			"crn:v1:watson::"+gaasServices[6]+":::::",
		State:				"ok",
		OperationalStatus: 	"none",
		SourceID:			"resource_idmain9b",
		Source:				"gaas_test_sourcemain9b",
		Status:				"ok",
	...
	maintCRN9a := []string{"crn:v1:watson:public:"+gaasServices[5]+":locationmain9a::::"}
	maintCRN9b := []string{"crn:v1:::"+gaasServices[5]+":locationmain9a::::","crn:v1:watson::"+gaasServices[6]+":locationmain9b:scopemain9b:::"}
	...
	if len(*maintJuncGet) != 2  {
		log.Println("Should have 2 entries in MaintenanceJunction")
		failed++
	} else {
		log.Println("Update Maintenance Add CRN passed")
	}
	...
	crnFull10 := []string{"crn:v1::public:"+gaasServices[1]+":location2::::",
						"crn:v1::aa:LIBERTY-for-java:location3::::",
				}
	...
	queryStr10 := db.RESOURCE_QUERY_CRN + "=crn:v1:watson::"+gaasServices[1]+":::::" + "&" + db.MAINTENANCE_QUERY_CREATION_TIME_START + "=" + creationTimeStart10 +"&" +db.MAINTENANCE_QUERY_CREATION_TIME_END+"=" + creationTimeEnd10
	...
	queryStr10d := db.RESOURCE_QUERY_CRN + "=crn:v1::public:"+gaasServices[1]+":::::" + "&" + db.MAINTENANCE_QUERY_CREATION_TIME_START + "=" + creationTimeStart10 +"&" +db.MAINTENANCE_QUERY_CREATION_TIME_END+"=" + creationTimeEnd10 +"&"+db.MAINTENANCE_COLUMN_PNP_REMOVED+"=true"
	...
	queryStr10e := db.RESOURCE_QUERY_CRN + "=crn:v1::aa:"+gaasServices[1]+":::::" + "&" + db.MAINTENANCE_QUERY_CREATION_TIME_START + "=" + creationTimeStart10 +"&" +db.MAINTENANCE_QUERY_CREATION_TIME_END+"=" + creationTimeEnd10
