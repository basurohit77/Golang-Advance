...
func TestServices4EDB(t *testing.T) {
	...
	m1.OSSService.GeneralInfo.OSSTags = osstags.TagSet{osstags.StatusCRNGreen, osstags.OneCloud, osstags.EDBInclude}
	...
	m1.OSSValidation.AddNamedIssue(ossvalidation.EDBMissingClientFacing, "")
	...
	m2.OSSService.GeneralInfo.OSSTags = osstags.TagSet{osstags.StatusCRNGreen, osstags.EDBExclude}
	...
	m2.OSSValidation.AddNamedIssue(ossvalidation.EDBFoundButExcluded, "")
	...
	for i := 0; i < 10; i++ {
		m := new(ossrecord.Metric)
		m3.OSSService.MonitoringInfo.Metrics = append(m3.OSSService.MonitoringInfo.Metrics, m)
		switch i % 3 {
		case 0:
			m.Type = ossrecord.MetricProvisioning
		case 1:
			m.Type = ossrecord.MetricConsumption
		default:
			m.Type = ossrecord.MetricOther
		}
		switch i % 2 {
		case 0:
			m.AddTags(ossrecord.MetricTagSourceEDB)
		}
	}
	...
	m3.OSSValidation.AddNamedIssue(ossvalidation.EDBMissingClientFacingNonStandard, "")
	...
	err := Services4EDB(buffer, timeStamp, pattern)
